...
describe('Subtract one (default)', (): void => {
  test.each([
    [
      ...
      new Date(2019, 4, 2, 10, 15, 31, 122),
    ],
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 6, 19, 3, 43, 11, 741),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 11, 7, 19, 27, 7, 12),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 0),
      new Date(2020, 11, 7, 19, 27, 6, 999),
    ],
  ])(
    'One millisecond',
    (date, expected): void => {
  ...
  test.each([
    [
      new Date(2019, 4, 2, 10, 15, 31, 123),
      new Date(2019, 4, 2, 10, 15, 30, 123),
    ],
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 6, 19, 3, 43, 10, 742),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 11, 7, 19, 27, 6, 13),
    ],
    [
      new Date(2020, 11, 7, 19, 26, 0, 13),
      new Date(2020, 11, 7, 19, 25, 59, 13),
    ],
  ])(
    'One second',
    (date, expected): void => {
  ...
  test.each([
    [
      new Date(2019, 4, 2, 10, 15, 31, 123),
      new Date(2019, 4, 2, 10, 14, 31, 123),
    ],
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 6, 19, 3, 42, 11, 742),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 11, 7, 19, 26, 7, 13),
    ],
  ...
  test.each([
    [
      new Date(2019, 4, 2, 10, 15, 31, 123),
      new Date(2019, 4, 2, 9, 15, 31, 123),
    ],
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 6, 19, 2, 43, 11, 742),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 11, 7, 18, 27, 7, 13),
    ],
    [
      new Date(2020, 11, 10, 0, 27, 7, 13),
      new Date(2020, 11, 9, 23, 27, 7, 13),
    ],
  ])(
    'One hour',
    (date, expected): void => {
  ...
  test.each([
    [
      new Date(2019, 4, 2, 10, 15, 31, 123),
      new Date(2019, 4, 1, 10, 15, 31, 123),
    ],
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 6, 18, 3, 43, 11, 742),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 11, 6, 19, 27, 7, 13),
    ],
    [
      new Date(2020, 11, 1, 19, 27, 7, 13),
      new Date(2020, 10, 30, 19, 27, 7, 13),
    ],
  ])(
    'One day',
    (date, expected): void => {
  ...
  test.each([
    ...
    [
      new Date(2018, 6, 19, 3, 43, 11, 742),
      new Date(2018, 5, 19, 3, 43, 11, 742),
    ],
    [
      new Date(2020, 11, 7, 19, 27, 7, 13),
      new Date(2020, 10, 7, 19, 27, 7, 13),
    ],
